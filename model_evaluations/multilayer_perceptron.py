...
def train_test(data):
    ...
    # Initialise MLP model and GridSearch
    MLP = MLPClassifier(random_state=42)
    grid_search = GridSearchCV(MLP, hyperparameters, cv=5, scoring='accuracy', verbose=1, n_jobs=-1)
    ...
    y_pred = MLP_best.predict(test_examples)
    ...
    # ROC Curve and AUC
    fpr, tpr, _ = roc_curve(test_labels, MLP_best.predict_proba(test_examples)[:, 1])
    roc_auc = auc(fpr, tpr)
